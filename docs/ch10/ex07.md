...
&emsp;&emsp;编写一个程序，初始化一个`double`类型的二维数组，使用编程练习2中的一个拷贝函数把该数组中的数据拷贝至另一个二维数组中（因为二维数组是数组中的数组，所以可以使用处理一维数组的拷贝函数来处理数组中的每一子数组）。

**解答：**  
代码位置：`exercises/ch10/ex07.c`
```c
#include <stdio.h>
...
**执行结果：**
```
CPrimerPlus\cmake-build-debug-mingw\ex10-07.exe
